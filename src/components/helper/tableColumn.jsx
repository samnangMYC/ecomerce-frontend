...
export const adminOrderColumns = (handleEdit, handleListOrder) => [
  {
    field: "id",
    headerName: "Order Id",
...

  {
    ...
    renderCell: (params) => (
      <div className="w-full text-gray-700 text-center">
        <span
          className={`inline-block px-4 py-1 rounded-full text-sm font-semibold ${params.value === "Accepted"
  ...
  },
  {
    ...
    renderCell: (params) => (
      <div className="flex justify-center gap-2 items-center h-full">
        <button
          type="button"
          onClick={() => { handleListOrder(params.row) }}
        ...
        <button
          ...
          className="text-white flex gap-1  bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 
...
export const adminCategoriesColumns = (handleEdit, handleDelete) => [
  {
    field: "id",
...
export const adminSellerColumn = (handleEdit, handleDelete) => [
  {
    field: "id",
